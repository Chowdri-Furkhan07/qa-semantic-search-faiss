...
![Streamlit](https://img.shields.io/badge/streamlit-1.38.0-FF4B4B?style=flat-square&logo=streamlit&logoColor=white)
![FAISS](https://img.shields.io/badge/FAISS-1.8.0-4B8BBE?style=flat-square)
...
│   ├── file-uploaded.png
│   └── search-results.png
├── ci.yml                        # Lint + test on every push (GitHub Actions)
...
**Furkhan**
B.E. in Artificial Intelligence and Machine Learning, VVIT Bengaluru
